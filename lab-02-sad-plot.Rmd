...
author: "Group Members: Eddie Jiang, Sarah Brown-Scott, Benjamin Mitchell and Sitong Zhang"
date: "`r Sys.Date()`"
...
*There are no lines showing data.*

```{r lineplot-1}
staff_long %>%
     ggplot(aes(x = year, y = number_or_people, color = faculty_type)) +
     geom_line()
```
